...
class TestCostEstimator:
    ...
    def test_cost_estimator_init(self, spark_session):
        """Test CostEstimator initialization."""
        from pyspark.sql import DataFrame
        table_a = spark_session.createDataFrame([(i,) for i in range(1000)], ['_id'])
        table_b = spark_session.createDataFrame([(i,) for i in range(1000)], ['_id'])
        nthreads = 4
